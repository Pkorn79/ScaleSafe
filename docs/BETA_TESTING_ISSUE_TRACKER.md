...
- Expected: due pulse fires `ss_app_event` with `event_type = Pulse Check Due`; GHL workflow execution and outbound message are verified separately; client submission creates pulse evidence linked to the enrollment.
