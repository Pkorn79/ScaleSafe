...
- Phase 5 payment workflow proof is still live-testing work: enrollment complete, payment received, recurring receipt, failed payment, NMI recurring webhook, and Stripe sanity test. Payment reminders are verified working from multiple live upcoming-payment reminder sends as of Philip's 2026-06-24 retest.
