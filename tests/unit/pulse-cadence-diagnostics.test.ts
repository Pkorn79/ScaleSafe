  ...
  it('syncs pulse contact fields and fires the shared app-event payload with durable aliases', async () => {
    ...
    expect(mockFireTrigger).toHaveBeenCalledWith(
      ...
      expect.objectContaining({
        ...
        pulse_url: expect.stringContaining('/pulse-check?actionToken='),
        pulse_check_link: expect.stringContaining('/pulse-check?actionToken='),
        link: expect.stringContaining('/pulse-check?actionToken='),
