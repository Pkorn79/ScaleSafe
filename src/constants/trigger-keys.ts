...
const TRIGGER_KEY_ALIASES: Record<string, TriggerKey> = {
  ...
  cancellationrequested: 'ss_cancellation_requested',
  sessionlogged: 'ss_session_logged',
  sessionnoshow: 'ss_session_noshow',
  modulecompleted: 'ss_module_completed',
  programcompleted: 'ss_program_completed',
  milestonereached: 'ss_milestone_reached',
  milestonesignedoff: 'ss_milestone_signedoff',
  paymentreceived: 'ss_payment_received',
  ...
  chargebackratiocritical: 'ss_chargeback_ratio_critical',
