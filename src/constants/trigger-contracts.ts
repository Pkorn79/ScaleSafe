...
export const TRIGGER_CONTRACTS: Record<TriggerKey, TriggerContract> = {
  enrollment_complete: {
    ...
    owner: 'enrollment',
    firesFrom: 'Welcome/access after enrollment completion',
    sourceType: 'checkout',
    audience: 'contact',
    betaStatus: 'critical',
  ...
  ss_payment_received: {
    ...
    owner: 'payment',
    firesFrom: 'Receipt/payment confirmation for checkout, manual sale, recurring billing, Stripe webhook, or NMI webhook',
    sourceType: 'webhook',
    audience: 'contact',
    betaStatus: 'critical',
  ...
  ss_send_enrollment_link: {
    ...
    owner: 'enrollment',
    firesFrom: 'Enrollment packet link from ScaleSafe, including pay-first enrollment links',
    sourceType: 'manual',
    audience: 'contact',
    betaStatus: 'important',
  ...
  ss_app_event: {
    ...
    owner: 'system',
    firesFrom: 'Shared app event path; pulse uses event_type=pulse_check_due and payment reminders use event_type=upcoming_payment_reminder',
    sourceType: 'scheduled',
    audience: 'contact',
    betaStatus: 'critical',
